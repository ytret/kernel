...
static char const * sect_name(elf_hdr_t const * p_hdr,
...
static bool
check_hdr_valid (elf_hdr_t const * p_hdr)
{
...
static void
dump_general (elf_hdr_t const * p_hdr)
{
    printf("ELF");
...
static void
dump_prog_hdrs (elf_hdr_t const * p_hdr)
{
...
static void
dump_prog_hdr (prog_hdr_t const * p_phdr)
{
    ...
    printf("0x%08x  0x%08x  %10u  %10u  %5u  %5s\n",
           p_phdr->offset, p_phdr->vaddr, p_phdr->file_size, p_phdr->mem_size,
           p_phdr->align, p_flags);
}

static void
dump_sect_hdrs (elf_hdr_t const * p_hdr)
{
...
static void
dump_sect_hdr (elf_hdr_t const * p_hdr, sect_hdr_t const * p_shdr)
{
...
static char const *
sect_name (elf_hdr_t const * p_hdr, sect_hdr_t const * p_shdr)
{
    if (0 == p_hdr->shstrndx)
    {
        return (NULL);
...
static void const *
offset (elf_hdr_t const * p_hdr, uint32_t offset)
{
